 ...
 */
final class Version20231009135955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actor ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE firstname firstname VARCHAR(255) DEFAULT NULL, CHANGE dob dob DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE movie ADD title VARCHAR(255) NOT NULL, ADD relation VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE messenger_messages CHANGE delivered_at delivered_at DATETIME DEFAULT \'NULL\' COMMENT \'(DC2Type:datetime_immutable)\'');
        $this->addSql('ALTER TABLE actor DROP created_at, CHANGE firstname firstname VARCHAR(255) DEFAULT \'NULL\', CHANGE dob dob DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE movie DROP title, DROP relation');
    }
}
